...
SomeClientConfig = {}
SomeClientConfig.mFinished = false
...
local function part2(timedout)
  ...
  local instance = GSHelperMethods.getInstance("SomeClientConfig")

  assert(3000 == instance.getRetryBase())
  assert(120000 == instance.getRetryMax())
  ...
  SomeClientConfig.mFinished = true
end

function SomeClientConfig:start(writeTextFunc)
  writeText = writeTextFunc
  
  writeText("SomeClientConfig => ")
  
  print("##############################################")
  print("### SomeClientConfig                       ###")
  print("##############################################")
  
  local availEvent = AutoResetEvent.new(false)
  local instance = GSHelperMethods.createInstance("SomeClientConfig")

  instance.setCustomServiceUrl("ws://127.0.0.1:50000")
  instance.setLogger(function(text) print(text) end)
  instance.setApiSecret("XXX")
  instance.setApiKey("SOME_CLIENT_CONFIG")
