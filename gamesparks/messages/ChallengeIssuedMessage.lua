...
local ChallengeIssuedMessage = {}
local ChallengeIssuedMessage_mt = {__index = ChallengeIssuedMessage}

function ChallengeIssuedMessage.new(data)
  local instance = GSResponse.new(data)
  return setmetatable(instance, ChallengeIssuedMessage_mt)
end

setmetatable(ChallengeIssuedMessage, {__index = GSResponse})

	
		
-- An object representing the challenge.
-- method type 2 - typed object return type
function ChallengeIssuedMessage:getChallenge()
...
function ChallengeIssuedMessage:getMessage()
...
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getMessageId()
...
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getNotification()
...
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getScriptData()
...
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getSubTitle()
...
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getSummary()
...
-- A textual title for the message.
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getTitle()
...
-- method type 5 - primitive return type
function ChallengeIssuedMessage:getWho()
