...
local ChallengeChangedMessage = {}
local ChallengeChangedMessage_mt = {__index = ChallengeChangedMessage}

function ChallengeChangedMessage.new(data)
  local instance = GSResponse.new(data)
  return setmetatable(instance, ChallengeChangedMessage_mt)
end

setmetatable(ChallengeChangedMessage, {__index = GSResponse})

	
		
-- An object representing the challenge.
-- method type 2 - typed object return type
function ChallengeChangedMessage:getChallenge()
...
-- method type 2 - typed object return type
function ChallengeChangedMessage:getLeaderboardData()
...
function ChallengeChangedMessage:getMessageId()
...
-- method type 5 - primitive return type
function ChallengeChangedMessage:getNotification()
...
-- method type 5 - primitive return type
function ChallengeChangedMessage:getScriptData()
...
-- method type 5 - primitive return type
function ChallengeChangedMessage:getSubTitle()
...
-- method type 5 - primitive return type
function ChallengeChangedMessage:getSummary()
...
-- A textual title for the message.
-- method type 5 - primitive return type
function ChallengeChangedMessage:getTitle()
...
-- method type 5 - primitive return type
function ChallengeChangedMessage:getWho()
